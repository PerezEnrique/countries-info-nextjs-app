...
export const getStaticProps: GetStaticProps<{countries: Country[], regions: string[]}> = async () => {
...
export default function index({countries, regions}: InferGetStaticPropsType<typeof getStaticProps>) {
    ...
    <main>
        ...
        <CardGrid
			...
			>
				{countriesToDisplay.map((item) => <CountryCard key={item.cca3} country={item} />)}
		</CardGrid>
    </main>
  )
}
