...
import { getBorders, getCountries, getSingleCountry } from "services/countriesService";
...
export const getStaticProps: GetStaticProps<{country: Country, borders: string[]}> = async ({params}) => {
...
export default function Country({country, borders}:  InferGetStaticPropsType<typeof getStaticProps>) {

    const { flags, name, region, subregion, capital, currencies, languages, tld } =
    country;
